...
```{r}
compare(m_linked_n_round_random,m_performance_round_random,m_performance_linked_n,m_full)
...
# + an ensemble model
ens = ensemble(m_linked_n_round_random,m_performance_round_random,m_performance_linked_n,m_performance_linked_n_round,m_linked_n_performance_round,m_full)
...
ppc_stat(y,y_full,stat = 'success',binwidth = 0.01)
ppc_stat(y,y_ens,stat = 'success',binwidth = 0.01)
```


# 4. Results of each effect (use only best model) and plot it
```{r}
